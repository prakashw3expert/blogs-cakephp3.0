...
$tableHeaders[] = array($this->Paginator->sort(__('name'), '') => array('style' => 'width:5%'));
$tableHeaders[] = array('' => array('style' => 'width:15%'));
$tableHeaders[] = array($this->Paginator->sort(__('email')) => array('style' => 'width:30%'));
$tableHeaders[] = array($this->Paginator->sort(__('age'), 'Age & Gender') => array('style' => 'width:15%'));
$tableHeaders[] = array($this->Paginator->sort(__('countries.name'),'Country') => array('style' => 'width:15%'));

$tableHeaders[] = array($this->Paginator->sort(__('created'), 'Join Date') => array('class' => 'date-class', 'style' => 'width:10%'));
