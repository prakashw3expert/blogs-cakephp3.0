                        ...
                        <div class="modal-dialog"> 
                                        ...
                                        <div class="col-md-4"> 
                                            <div class="form-group"> 
                                                ...
                                                echo $this->Form->input('sale_chanel', [
                                                    ...
                                                    'options' => array('Everywhere' => 'Both', 'Online' => 'Online', 'Door' => 'At Venue')
                                                ]);
                                                ?>
                                                <span class="small">Nulla facilisi. Nam commodo suscipit quam</span>
                                            </div> 
                                        </div> 
                                    </div> 
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="tablesaw table tablesaw-swipe table-bordered">
                                    ...
                                    <tbody>
                                        <tr ng-repeat="(key, value) in tickets track by $index">
                                            <td>{{value.id}}</td>
                                            <td>{{value.name}}</td>
                ...
                <div class="row">
                    ...
                    if (!empty($orders)) {
                        ...
                        foreach ($orders as $key => $listOne) {
                            ...
                            $row[] = $listOne->id;
                            $row[] =  implode(' / ', $tickets);
                            $row[] = $this->Html->link($listOne->user->name,['controller' => 'authors','action' => 'view','slug' => $listOne->user->slug],['target' => '_blank']);
