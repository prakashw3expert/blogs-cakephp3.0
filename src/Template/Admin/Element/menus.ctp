...
$activeClass = ($controller == 'events') ? 'active' : null;
$menus[] = $this->Html->link('<i class="ion-calendar"></i><span> Events </span>',['plugin' => false,'controller' => 'events','action' => 'index'],['escape' => false,'class' => $activeClass]);


$activeClass = ($controller == 'contests') ? 'active' : null;
$menus[] = $this->Html->link('<i class=" ti-cup"></i><span> Contests </span>',['plugin' => false,'controller' => 'contests','action' => 'index'],['escape' => false,'class' => $activeClass]);

$activeClass = ($controller == 'magazines') ? 'active' : null;
$menus[] = $this->Html->link('<i class="ti-book"></i><span> Magazines </span>',['plugin' => false,'controller' => 'magazines','action' => 'index'],['escape' => false,'class' => $activeClass]);
