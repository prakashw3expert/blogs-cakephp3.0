                    ...
                    <div class="wpb_wrapper">
                        <div class="tabs event-tab upcoming-popular-tab">
                            ...
                            <ul class="clearfix">
                                ...
                                <li><a href="#popular_events">Popular Events</a></li>
                            </ul>
                            ...
                            <div id="popular_events">
                                <div class="event-container">
                                    <div class="row">
                                        <?= $this->cell('Event::popular', [], ['cache1' => true]) ?>
                                    </div>
                                </div>
                            </div>

                            <a href="http://localhost/themes/event/innwithemes.com/eventonwp/event/index.html" target="_self" class="clear btn btn-border btn-md btn-color">View All Event</a>
                        </div>
