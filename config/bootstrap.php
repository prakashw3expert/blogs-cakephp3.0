...
Plugin::load(['Crud', 'BootstrapUI','Settings' => ['routes' => true,'autoload' => true],'Seo' => ['routes' => true,'autoload' => true]]);
...
try {
    Configure::config('yaml', new YamlConfig());
    Configure::load('categories', 'yaml');
} catch (\Exception $e) {
    die('Unable to load config/categories.yml.');
}
